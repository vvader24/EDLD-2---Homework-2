...
vertical.lines = c(0,15000, 30000,45000,60000,75000)
df = tibble(x.axis.label =c("0","15,000","30,000","45,000","60,000","75,000"),
x = rep(0,6),
y = c(0,15000, 30000,45000,60000,75000)
)
transit_cost_by_c %>%
...
geom_point(color = "cornflower blue") +
  scale_y_continuous(breaks = c(0,15000,30000,45000,60000,75000), labels = c("0","15,000","30,000","45,000","60,000","75,000"))+
coord_flip()+
  labs(x = "Country",
  ...
  geom_hline(yintercept = vertical.lines, color="grey80")
